...
class TestTiles(unittest.TestCase):
    ...
    def test_tileI(self):
        ...
        self.assertEqual(tile.value, 1)
        self.assertEqual(tile.cantidad, 6)
    def test_tileJ(self):
        tile = Tile("J", 8, 1)
    ...
    def test_tileO(self):
        ...
        self.assertEqual(tile.value, 1)
        self.assertEqual(tile.cantidad, 9)
    def test_tileP(self):
        tile = Tile("P", 3, 2)
